...
import com.akshay.ignite.sample.datastore.DataframeIgniteCache
...
class SparkSummarizeService extends SparkService with Service{

  var appName = ""
  val CONFIG = "config/cache.xml"
  override def runService(inputKey: String, outputKey: String, config: Any): Unit = {
